            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right">Tambah Buku Baru</a>
                        <a href="create.php" class="btn btn-success pull-right">Tambah Kategori Baru</a>
                    </div>
                    <?php
                    // Include config file
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td><img src='' alt='". $row['image'] ."' border=3 height=100 width=300></img></td>";
